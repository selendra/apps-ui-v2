...
export const prodParasSelendraCommon: EndpointOption[] = [
  {
    ...
    teleport: [-1],
    providers: {
      "Digital Ocean 0": 'wss://rpc0-indranet.selendra.org',
      "Digital Ocean 1": 'wss://rpc1-indranet.selendra.org',
    }
  },
  // {
...
export const prodRelaySelendra: EndpointOption = {
  ...
  text: 'Selendra',
  providers: {
    "Digital Ocean 0": 'wss://rpc0.selendra.org',
    "Digital Ocean 1": 'wss://rpc1.selendra.org',
  },
