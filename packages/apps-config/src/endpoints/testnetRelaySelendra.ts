...
export const testParasSelendraCommon: EndpointOption[] = [
  {
    info: 'Indranet Testnet',
    paraId: 1000,
    text: 'Indranet Testnet',
    teleport: [-1],
    providers: {
      "Digital Ocean 0": 'wss://rpc0-testnet-indranet.selendra.org',
      "Digital Ocean 1": 'wss://rpc1-testnet-indranet.selendra.org',
    }
  },
  // {
...
export const testRelaySelendra: EndpointOption = {
  ...
  teleport: getTeleports(testParasSelendraCommon),
  linked: [
    ...testParasSelendraCommon,
    // ...prodParasPolkadot
  ]
};
